      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 10 }}>
        ...
        >
          ...
          <View className="mt-16 items-center px-3">
            ...
            <Text className="mt-6 max-w-[720px] text-center text-[44px] font-bold leading-[48px] text-ink">
          ...
          <View className="mt-10 flex-row flex-wrap" style={{ gap: 16 }}>
            <View
              className={`${isDesktop ? "flex-1" : "w-full"} rounded-[30px] border border-[#E7EAF1] bg-white px-6 py-7`}
            >
              <Text className="text-[12px] font-semibold uppercase tracking-[1px] text-[#7D8594]">Free</Text>
              <Text className="mt-4 text-[46px] font-bold text-ink">$0</Text>
              <Text className="mt-1 text-[15px] text-[#68707F]">Forever. No card required.</Text>
              <View className="mt-6 h-px bg-[#E7EAF1]" />
              <View className="mt-6" style={{ gap: 14 }}>
                {[
                  ...
                  <View key={feature} className="flex-row items-center" style={{ gap: 10 }}>
                    <View className="h-5 w-5 items-center justify-center rounded-full bg-[#EEF9F2]">
                      <Text className="text-[10px] font-bold text-[#1D8F5F]">✓</Text>
                    </View>
                    <Text className="flex-1 text-[15px] text-[#556071]">{feature}</Text>
                  </View>
                ))}
              </View>
              <View className="mt-8">
                <Link href={"/auth" as never} asChild>
                  <Pressable className="items-center rounded-full border border-[#E7EAF1] bg-[#F7F8FC] px-6 py-4">
                    <Text className="text-[15px] font-semibold text-ink">Get started free</Text>
                  </Pressable>
                </Link>
              </View>
            </View>
            ...
            <View
              className={`${isDesktop ? "flex-1" : "w-full"} overflow-hidden rounded-[30px] border-2 border-[#111111] bg-[#111111] px-6 py-7`}
            >
              <View className="mb-4 self-start rounded-full bg-[#F5C400] px-3 py-1">
                <Text className="text-[11px] font-bold uppercase tracking-[0.8px] text-[#111111]">Premium</Text>
              </View>
              <Text className="text-[12px] font-semibold uppercase tracking-[1px] text-[#9A9FAD]">Monthly</Text>
              <View className="mt-3 flex-row items-end" style={{ gap: 6 }}>
                <Text className="text-[46px] font-bold text-white">$4.99</Text>
                <Text className="mb-3 text-[16px] text-[#6B7180]">/mo</Text>
              </View>
              <Text className="mt-1 text-[15px] text-[#8A91A4]">Or $39.99/year — save 33%.</Text>
              <View className="mt-6 h-px bg-[#2A2E38]" />
              <View className="mt-6" style={{ gap: 14 }}>
                {[
                  "Unlimited imports, any platform",
                  ...
                  <View key={feature} className="flex-row items-center" style={{ gap: 10 }}>
                    <View className="h-5 w-5 items-center justify-center rounded-full bg-[#F5C400]">
                      <Text className="text-[10px] font-bold text-[#111111]">✓</Text>
                    </View>
                    <Text className="flex-1 text-[15px] text-[#C8CDD8]">{feature}</Text>
                  </View>
                ))}
              </View>
              <View className="mt-8">
                <Link href={"/auth" as never} asChild>
                  <Pressable className="items-center rounded-full bg-[#F5C400] px-6 py-4">
                    <Text className="text-[15px] font-bold text-[#111111]">Start free trial</Text>
                  </Pressable>
                </Link>
              </View>
            </View>
